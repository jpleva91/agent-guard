...
| agents object | 120 entries (118 enabled) | PASS |
...
| policy-effectiveness-agent | no | — | PASS |
| security-code-scan-agent | no | — | PASS |
...
**Summary:** 94 OK, 24 MISSING, 0 EMPTY
...
| policy-effectiveness-agent | no (disabled) | yes | n/a | WARN |
...
| security-code-scan-agent | no (disabled) | yes | n/a | WARN |
...
**Summary:** 68 PASS, 35 WARN (33 scheduled but not registered, 2 registered but disabled in schedule), 0 repo mismatches
...
1. **FAIL — 24 enabled agents missing SKILL.md**: director, swarm-health-agent, cloud-em, cloud-sr, cloud-qa, onboarding-monitor-agent, hq-em, workspace-backlog-steward, analytics-em, analytics-pipeline, analytics-reporter, analytics-invariant-researcher, analytics-pr-review-agent, qa-em, marketing-em, marketing-launch-agent, site-em, site-builder, site-docs-sync, design-em, design-auditor, office-sim-em, office-sim-sr, office-sim-qa. These agents will fail at runtime because the scheduler cannot find their task definitions.
2. **FAIL — Repo `agentguard-analytics` does not exist**: 5 analytics squad agents (analytics-em, analytics-pipeline, analytics-reporter, analytics-invariant-researcher, analytics-pr-review-agent) reference this repo but the directory is not present in the workspace. These agents cannot run.
3. **WARN — 33 enabled agents not in agent-registry.json**: director, kernel-em, kernel-sr, kernel-qa, swarm-health-agent, cloud-em, cloud-sr, cloud-qa, onboarding-monitor-agent, hq-em, workspace-backlog-steward, analytics-em, analytics-pipeline, analytics-reporter, analytics-invariant-researcher, analytics-pr-review-agent, qa-em, marketing-em, marketing-launch-agent, site-em, site-builder, site-docs-sync, design-em, design-auditor, office-sim-em, office-sim-sr, office-sim-qa, studio-em, studio-sr, studio-jr, studio-product, studio-qa, studio-designer. These agents lack identity configuration and will run without governance identity.
4. **WARN — 2 agents registered but disabled in schedule**: policy-effectiveness-agent, security-code-scan-agent. These have registry entries but are disabled — no action needed unless re-enabling is intended.
