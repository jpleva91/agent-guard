...
| agents (total) | 120 | PASS |
| cron expressions (5-field) | 118/118 | PASS |
...
| cicd-hardening-agent-cloud | yes | no | n/a | WARN |
...
| policy-effectiveness-agent | disabled | yes | — | WARN |
| security-code-scan-agent | disabled | yes | — | WARN |

**Summary:** 83 PASS, 35 WARN, 0 FAIL
...
1. **FAIL — 24 enabled agents missing SKILL.md**: director, swarm-health-agent, cloud-em, cloud-sr, cloud-qa, onboarding-monitor-agent, hq-em, workspace-backlog-steward, analytics-em, analytics-pipeline, analytics-reporter, analytics-invariant-researcher, analytics-pr-review-agent, qa-em, marketing-em, marketing-launch-agent, site-em, site-builder, site-docs-sync, design-em, design-auditor, office-sim-em, office-sim-sr, office-sim-qa — these agents will fail on startup because their SKILL.md (task instructions) cannot be found.

2. **FAIL — Repo directory missing: agentguard-analytics** — 5 agents (analytics-em, analytics-pipeline, analytics-reporter, analytics-invariant-researcher, analytics-pr-review-agent) reference this repo but it does not exist in the workspace. These agents cannot run.

3. **WARN — 33 enabled agents not in agent-registry.json**: director, kernel-em, kernel-sr, kernel-qa, swarm-health-agent, cloud-em, cloud-sr, cloud-qa, onboarding-monitor-agent, hq-em, workspace-backlog-steward, analytics-em, analytics-pipeline, analytics-reporter, analytics-invariant-researcher, analytics-pr-review-agent, studio-em, studio-sr, studio-jr, studio-qa, studio-product, studio-designer, qa-em, marketing-em, marketing-launch-agent, site-em, site-builder, site-docs-sync, design-em, design-auditor, office-sim-em, office-sim-sr, office-sim-qa — these agents have no identity assigned and will trigger the "No agent identity set" prompt at startup.

4. **WARN — 1 enabled agent in schedule not in registry: cicd-hardening-agent-cloud** — scheduled but missing from agent-registry.json.

5. **WARN — 2 disabled agents still in registry**: policy-effectiveness-agent, security-code-scan-agent — registry entries exist for agents that are disabled in the schedule. Consider removing stale registry entries.
