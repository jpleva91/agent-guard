...
- `documentHashes`: object with keys for <%= paths.roadmap %>, docs/strategic-roadmap.md, docs/current-priorities.md — use the first 8 chars of `sha256sum` output for each
