...
Cross-reference the "Active Phase" stated in `docs/current-priorities.md` with the actual phase derived from <%= paths.roadmap %> checkboxes. Note any discrepancy.
